  ...
  return (
    <div className={css.container}>
      ...
      <div className={css.langLinks}>
        <Button startIcon={<LanguageIcon/>} onClick={()=>{setLanguage("ru")}} disabled={language==='ru'}> RU </Button>
        <Button startIcon={<LanguageIcon/>} onClick={()=>{setLanguage("en")}} disabled={language==='en'}> EN </Button>
      </div>
              ...
              <ListItem>
                <div className={css.contactsBlock}>
                  <Box display="flex" alignItems="center">
                    {contacts.social.facebook? <Link to={contacts.social.facebook}><FacebookRounded/></Link> : ''}
                    {contacts.social.instagram? <Link to={contacts.social.instagram}><Instagram/></Link> : ''}
                    {contacts.social.tripadvisor? <Link to={contacts.social.tripadvisor}><FindInPageRounded/></Link> : ''}
                  </Box>
                  <Box display="flex" alignItems="left">
                    <EmailRounded />
                    <Typography variant="caption"><Link to={`mailto:${contacts.email}`}>{contacts.email}</Link></Typography>
                  </Box>
                  <Box display="flex" alignItems="left">
                    <Phone />
                    <Typography variant="caption">(WhatsApp)<Link to={`tel:${contacts.phone}`}>{contacts.phone}</Link></Typography>
                  </Box>
                </div>
              </ListItem>: ''}
